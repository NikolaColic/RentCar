                ...
                try
                {
                    ...
                    switch (transferClass.Operation)
                    {
                        ...
                        case Operation.CreateReservation:
                            List<Reservation> rezervacije = new List<Reservation>();
                            
                            foreach(Reservation r in (BindingList<Reservation>)transferClass.ListaObj)
                            {
                                CreateReservation createReservation = new CreateReservation();
                                rezervacije.Add((Reservation)createReservation.ExecuteSystemOperation(r));
                            }
                            transferClass.Result = rezervacije;
                            break;
