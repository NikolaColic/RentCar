...
namespace rent_a_car.ClientSide
{
    internal class NetworkCommunication
    {
        ...
        internal List<Car> GetCarsByConditions(Car car)
        {
            ...
            if (transferObject.Result is null) return null;
        ...
        internal object CreateReservation(BindingList<Reservation> listaRezervacija)
        {
            binaryFormater = new BinaryFormatter();
            DataTransferObject transferObject = new DataTransferObject();

            transferObject.Operation = Operation.CreateReservation;
            transferObject.ListaObj = listaRezervacija;
